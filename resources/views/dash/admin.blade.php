...
<div class="py-6 px-4 flex-1">
    ...
    <h1 class="text-xl font-semibold text-gray-900 flex justify-between items-center">
        Administrators
        <a href="{{ route('dashboard.admin.create') }}" class="block w-32 p-2 font-normal text-center bg-blue-600 hover:bg-blue-400 active:border text-white cursor-pointer rounded">
            + Add new
        </a>
    </h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="border px-4 py-2">
                        <a href="{{ route('dashboard.admin.update', $admin->empno) }}" class="block p-2 text-center bg-green-600 hover:bg-green-400 active:border text-white cursor-pointer rounded">Update</a>
                        <a href="{{ route('dashboard.admin.delete', $admin->empno) }}" class="block p-2 text-center bg-red-600 hover:bg-red-400 active:border text-white cursor-pointer rounded">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
