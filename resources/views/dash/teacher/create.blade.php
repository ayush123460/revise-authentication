...
<div class="py-6 px-4 flex-1">
    ...
    <div class="container mt-5 bg-white mx-auto py-3 px-6 rounded text-gray-900">
        ...
        <form action="{{ route('dashboard.teacher.create') }}" method="POST" class="flex flex-col">
            ...
            <div class="item-group">
                ...
                <input type="text" name="empno" class="input">
            </div>

            <div class="item-group">
                <label for="empno">Cabin Number:</label>
                <input type="text" name="cabinno" class="input">
            </div>

            <div class="item-group">
                <label for="empno">Phone Number:</label>
                <input type="text" name="phone" class="input" maxlength="10">
            </div>
